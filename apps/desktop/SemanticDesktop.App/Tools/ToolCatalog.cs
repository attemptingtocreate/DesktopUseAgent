...
public static class ToolCatalog
{
    ...
    private static IReadOnlyList<AgentToolDefinition> CreateTools()
    {
        ...
        [
            ...
            ("office.mail_compose", "Compose an Outlook mail (COM) or mailto fallback."),
            ("office.calendar_week", "List Outlook calendar appointments for the current week."),
            ("media.transport", "Send media transport keys: play_pause, next, previous, stop."),
            ("media.volume", "Volume up/down/mute via keys, or set 0-100 via CoreAudio."),
            ...
            ("vision.ocr", "OCR text from window/monitor/region/path via Windows.Media.Ocr (structured JSON only; no pngBase64).")
        ];
