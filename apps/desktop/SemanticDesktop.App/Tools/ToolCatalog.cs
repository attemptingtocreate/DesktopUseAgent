...
public static class ToolCatalog
{
    ...
    private static IReadOnlyList<AgentToolDefinition> CreateTools()
    {
        ...
        [
            ...
            ("blender.execute_python", "Run Blender Python (live: confirm=true, 32KB, restricted)."),
            ...
            ("blender.create_mesh", "Create allowlisted Blender mesh primitive."),
            ("blender.export_for_roblox", "Export mesh with Roblox-oriented presets."),
            ("blender.mesh_extrude", "Extrude mesh region by value (optional indices)."),
            ("blender.mesh_inset", "Inset selected faces."),
            ("blender.mesh_bevel", "Bevel edges/verts."),
            ("blender.mesh_loop_cut", "Loop cut / subdivide fallback."),
            ("blender.modifier_boolean", "Boolean modifier with target mesh."),
            ("blender.modifier_mirror", "Mirror modifier on X/Y/Z."),
            ("blender.modifier_array", "Array modifier with count/offset."),
            ("blender.material_set", "Set Principled BSDF material/color."),
            ("blender.uv_unwrap", "UV unwrap (angle/conformal/smart)."),
            ("blender.select_geometry", "Select verts/edges/faces by indices."),
            ...
            ("roblox.create_instance", "Create an allowlisted Roblox instance under a parent."),
            ("roblox.destroy_instance", "Destroy a non-service Roblox instance."),
            ("roblox.clone_instance", "Clone a Roblox instance."),
            ("roblox.set_parent", "Reparent a Roblox instance."),
            ("roblox.find_instances", "Find instances by class/name/path."),
            ("roblox.get_script_source", "Read Script/LocalScript/ModuleScript Source."),
            ("roblox.set_script_source", "Write Script/LocalScript/ModuleScript Source (max 256KB)."),
            ("roblox.batch", "Batch up to 32 Roblox bridge operations in one round-trip."),
            ("roblox.playtest_start", "Start Studio play solo."),
            ("roblox.playtest_stop", "Stop Studio play solo."),
            ("roblox.terrain_fill_block", "Fill terrain block with material."),
            ("roblox.terrain_fill_ball", "Fill terrain ball with material."),
            ("roblox.terrain_clear", "Clear workspace Terrain."),
            ("roblox.insert_asset", "Insert Toolbox asset by assetId."),
            ("roblox.import_local_model", "Import local .rbxm/.rbxmx model."),
            ("roblox.publish_place", "Prompt/publish place (confirm=true)."),
            ("roblox.execute_luau", "Gated Luau exec (confirm=true, 16KB max)."),
